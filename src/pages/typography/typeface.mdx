...
Chinese is scheduled for release in 2022–2023 and will support both Traditional and Simplified Chinese. The Chinese scripts are currently under development. In the meantime, we have chosen an open source Chinese typefaces that can work well with the IBM Plex Family.
...
Fonts and Adobe Fonts Libraries to help make it available for all people to
