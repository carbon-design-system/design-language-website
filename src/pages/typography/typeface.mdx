...
The Chinese and Japanese scripts are currently under development. Japanese is scheduled for release in early 2021 and Chinese will have a staggered release due to the scale of the project. We will be supporting both Traditional and Simplified Chinese. In the meantime, we have chosen open source Chinese and Japanese typefaces that can work well with the IBM Plex Family.
