---
title: Type basics
description: Good typography starts with type basics tracking, leading, alignment and line length. Find guidance for best practices in the use of IBM IBM Plex®.
---
...
Some examples of correct use of hyphens and en dashes are shown here. An en dash is used to span or ranges of numbers (1945–1975) and the hyphen is for compound terms (check-in).
