---
title: Type specs UI
description: The proper application of type to reflect the IBM brand requires an understanding of scale, style, setting and color. Learn more about Type Specs.
---
