...
Stroke app icons are largely based on the styling of UI Icons, following all of the same production guidelines other than color. When creating stroke app icon, reference the [UI icon guidance](/elements/icons/overview) as a starting point.
...
When logos have a background container, use [keyshapes](/elements/icons/overview/#keyshapes) to guide your design. This makes it easier to create a visually stable foundation and helps to keep visual weight consistent between icons.
