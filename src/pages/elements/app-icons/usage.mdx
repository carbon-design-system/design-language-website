...
Most often, app icons are needed within product and web platforms and marketplaces. In these contexts, app icons should follow the same usage conventions as [UI icons](/elements/icons/usage) for sizing, alignment, and clearance.
