...
![IBM Cloud ad](/images/PlexThaiWall_RGB-03.svg)
...
<DoDontExample type="dont" caption="Avoid overcrowded layouts whenever possible.">

![Layout with too little negative space](/images/BreatheDont_v2.svg)
...
<DoDontExample type="dont" caption="Avoid uninspired layouts.">
...
![Asymmetric layout](/images/AsymmetryDo_v3.svg)
