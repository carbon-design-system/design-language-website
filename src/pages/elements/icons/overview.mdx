...
<Video src="/videos/icon-grid.mp4.mp4" poster="/images/icon-grid-poster.svg" />
...
<Column colMd={4} colLg={4}>
<DoDontExample type="dont" caption="">
...
https://design-language-api.eu-de.mybluemix.net/images/32x32-base-grid-padding.svg

<Row>
<Column colMd={4} colLg={4}>
<DoDontExample type="do" caption="Do Icon should remain inside the padding.">
...
https://design-language-api.eu-de.mybluemix.net/images/keyshape-comp.svg

https://design-language-api.eu-de.mybluemix.net/images/keyshape-examples.svg
