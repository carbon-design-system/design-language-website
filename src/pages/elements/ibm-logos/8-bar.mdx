...
There are many color backgrounds available to choose from when using the white logo. In order to achieve clear legibilty choose from the Black–60 range from the [IBM color palette](/elements/color).
