...
<Row>
<Column colMd={3} colLg={2} noGutterSm>

-- Create and add color block components --

<Caption>Light</Caption>

</Column>
<Column colMd={5} colLg={6} noGutterSm>
...
| Role                    | Hex Value | Color    |                                            |
| ----------------------- | --------- | -------- | ------------------------------------------ |
| Global Background Light | `#ffffff` | White    | <ColorBlock size="xs">#ffffff</ColorBlock> |
| Global Background Light | `#f3f3f3` | Gray 10  | <ColorBlock size="xs">#f3f3f3</ColorBlock> |
| Global Background Dark  | `#3d3d3d` | Gray 80  | <ColorBlock size="xs">#3d3d3d</ColorBlock> |
| Global Background Dark  | `#282828` | Gray 90  | <ColorBlock size="xs">#282828</ColorBlock> |
| Global Background Dark  | `#171717` | Gray 100 | <ColorBlock size="xs">#171717</ColorBlock> |
...
![](images/interaction-states-light-theme.svg)

<Caption>Light theme</Caption>

![](images/interaction-states-dark-theme.svg)
...
| Role                   | Hex Value | Color     |                                            |
| ---------------------- | --------- | --------- | ------------------------------------------ |
| Text – Primary Light   | `#171717` | Gray 100  | <ColorBlock size="xs">#171717</ColorBlock> |
| Text – Primary Dark    | `#f3f3f3` | Gray 10   | <ColorBlock size="xs">#f3f3f3</ColorBlock> |
| Text – Secondary Light | `#565656` | Gray 70   | <ColorBlock size="xs">#565656</ColorBlock> |
| Text – Secondary Dark  | `#bebebe` | Gray 30   | <ColorBlock size="xs">#bebebe</ColorBlock> |
| Text – Hint            | `#a4a4a4` | Gray 40   | <ColorBlock size="xs">#a4a4a4</ColorBlock> |
| Alert – Error          | `#da1e28` | Red 60    | <ColorBlock size="xs">#da1e28</ColorBlock> |
| Alert – Warning        | `#fdd13a` | Yellow 30 | <ColorBlock size="xs">#fdd13a</ColorBlock> |
| Alert – Success        | `#24a249` | Green 50  | <ColorBlock size="xs">#24a249</ColorBlock> |

<Row>
<Column>

![Common colors](images/commonly-used-colors.png)
