...
Logical repetition of elements, measurements, shapes, ratios, and proportions will drive consistency and quality. Expressive alternation—where appropriate—can break expectations and create visual interest. 
...
Facilitating eye movement through the composition creates a more visually interesting design. A focal point instantly attracts the eye to one area of the canvas. Secondary and tertiary elements then draw the eye across the canvas, creating more engagement between the viewer and the design. This is done best through [asymmetrical layouts](/elements/layout-composition/tips-and-techniques/#master-asymmetry), where thoughtful relationships between elements make for a more visually stimulating design. It's important to plan the movement of the eye in order to guide the viewer to the intended outcome.
