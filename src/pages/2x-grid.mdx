...
import v337387156 from '../videos/vimeo/337387156.mp4';
import p337387156 from '../videos/vimeo/337387156.jpg';
...
<video src={v337387156} controls preload="metadata" style={{width: "100%"}} poster={p337387156} />
