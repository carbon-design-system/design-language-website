---
title: 2x Grid
description: The IBM 2x Grid is a framework providing the structure that informs spatial relationships for everything we design from typography to visual elements.
---
...
The IBM 2x grid is the framework for all the visual elements and typography. It’s
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      ...
      aspectRatio="2:1"
      href="https://www.ibm.com/design/event/architecture/2x-grid"
      disabled
      >
...
![2x grid image](images/grid-ex-2x-grid-1.svg)
...
![2x grid image](images/grid-ex-2x-grid-2.svg)
...
![2x grid](images/grid-ex-2x-grid-3.svg)
...
![2x grid](images/grid-ex-2x-grid-with-margins.png)

<Caption>2x Grid</Caption>

</Column>
<Column colMd={4} colLg={6}>

![event grid](images/EventGridExample_v2.png)
...
Within the grid, columns and rows are especially important—they give layouts their structure. You can choose between 1, 2, 4, 8, and 16 divisions. Stick to your choice throughout your design to maintain structural rhythm.
...
![grid security](images/grid-ex-security-lg.png)
...
![rows grid](images/RowsGridExample_v2.png)
...
![grid image](images/grid-ex-columns-and-rows.png)
...
![divide right](images/divide-right.svg)
...
![divide wrong](images/divide-wrong.svg)
...
![grid image](images/grid-ex-with-gutters.png)
...
![grid image](images/grid-ex-without-gutters.png)
...
![gutters image](images/gutters-right.svg)
...
![gutters image](images/gutters-wrong.svg)
...
![mini unit](images/mini-unit-2mm.svg)
...
![standing banner](images/StandingBanner-01.svg)
...
![mini unit image](images/mini-unit-256mm.svg)
...
![baseline grid](images/BaselineGrid-01.svg)
...
![hybrid grid](images/HybridGrid-01.svg)
...
![standing banner](images/StandingBannerExample_v2.png)
...
![stationery example](images/StationeryExample_v2.png)
