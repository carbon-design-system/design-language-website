...
/>
<Caption>Not staggering horizontal and vertical animations creates a straight diagonal path. It breaks the grid and is harsh to the eye.</Caption>
...
Follow this recommended sequence of different types of content when choreographing content entrance. Not all categories might be present in every experience. [Learn to categorize content in Motion Strategy.](/motion/choreography)
