---
title: Motion UI
description: IBM brand embraces the use of productive and expressive motion to show progress, with rules for easing and duration. Test your ideas using our motion generator.
...
Our [components](https://www.carbondesignsystem.com/components/overview/) have basic motion built in. Use this guidance to customize, combine and coordinate motion throughout user experiences.
...
/>
<Caption>Elements on the screen speed up quickly and slow down smoothly, obeying the physics of a lightweight material.</Caption>
...
Cubic-bezier curve notation is the standard way to express easing curves. The [IBM Motion Package](https://www.npmjs.com/package/@carbon/motion) has the easing curves stored as tokens for fast access.
