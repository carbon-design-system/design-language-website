...
Cubic-bezier curve notation is the standard way to express easing curves. The [IBM Motion Package](https://github.com/carbon-design-system/carbon/tree/master/packages/motion) has the easing curves stored as tokens for fast access.
