...
import v296064420 from '../../videos/vimeo/296064420.mp4';
import p296064420 from '../../videos/vimeo/296064420.jpg';

<video src={v296064420} controls preload="metadata" style={{width: "100%"}} poster={p296064420} />
