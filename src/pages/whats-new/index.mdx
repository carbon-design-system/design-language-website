...
import v425895830 from '../../videos/vimeo/425895830.mp4';
import p425895830 from '../../videos/vimeo/425895830.jpg';
...
## IBM Plex Sans Chinese (Simplified)

<Row className={gridImages}>
<Column colLg={8} colMd={6}>

[![ ](./images/IBM_Plex_SC_Announcement.png)](/typography/typeface#language-support)

</Column>
</Row>

After more than two years of design and development, IBM Plex® Sans Chinese SC (Simplified) is now available. This follows the September release of IBM Plex® Chinese TC (Traditional) version, making Plex® Chinese a valuable landmark for our users. The release of Plex Chinese concludes the new language development for IBM Plex®. 2024 was a significant year for new releases, including both Traditional and Simplified Chinese, as well as Plex Math. You can find more information about the Plex typeface family in the [IBM Design Language](/typography/typeface#language-support) site and download IBM Plex Sans SC from [GitHub](https://github.com/IBM/plex/releases).<br/>— <br/>05 December 2024
...
## IBM Plex Sans Chinese (Traditional)
...
<video src={v425895830} controls preload="metadata" style={{width: "100%"}} poster={p425895830} />
