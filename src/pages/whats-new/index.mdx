...
[![link to IBM Plex Japanese page](./images/japanese_plex.gif)](https://w3.ibm.com/w3publisher/ibm-plex-japanese)

</Column>
</Row>

After two years of design and development, our custom-designed typeface, IBM Plex®, is now available in Japanese. IBM Plex Sans JP makes a fine addition to our non-Latin families and will continue to make IBM communications distinctive across all experiences in over 100 languages worldwide. Open source and free to use, Plex also comes in Arabic, Cyrillic, Devanagari, Greek, Hebrew, and Thai. Learn more on how to [use the Plex typeface family](https://w3.ibm.com/w3publisher/ibm-plex-japanese) (IBMId required) and download [IBM Plex Sans JP](https://github.com/IBM/plex/releases/tag/v5.2.1) here.<br/>— <br/>30 July, 2021
