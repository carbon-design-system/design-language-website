...
For the typefaces still missing from the Plex family
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
subTitle="2x Grid for video template"
aspectRatio="2:1"
actionIcon="download"
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle={<>IBM Business Partner marks<br />(IBM ID required)</>}
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle={<>Photogrphy library<br />(IBM ID required)</>}
      aspectRatio="2:1"
