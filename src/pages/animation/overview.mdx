---
title: Overview
description: Animation is a powerful communication tool. It can bring our work to life, guide viewers through complicated problems, tell meaningful stories and help make progress—from here to there, now to next, start to finish.
---
...
![Isometric illustration](../illustration/images/overview/hero.gif)
...
<Video
  poster="/images/animation/animation-overview-pe-poster.png"
  src="/videos/animation/animation-overview-pe.mp4"
/>
...
– &nbsp;&nbsp;*Productive* motion leans toward efficiency and responsiveness.<br/>
– &nbsp;&nbsp;*Expressive* motion is enthusiastic and vibrant.
...
Our animation is at its best when the conversation between productive and expressive motion is clearly apparent. Each type has an important role to play in a piece, and the push and pull between the two provide a compelling contrast, bringing a nuanced personality to each element in motion. 
...
Using either productive or expressive motion alone will inherently create different impressions. For example, productive elements may appear professional, confident, smart and efficient.
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Line style"
      href="https://www.ibm.com/design/language/illustration/line-style/design"
      >
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Flat style"
      href="https://www.ibm.com/design/language/illustration/flat-style/design"
      >
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Isomteric style"
      href="https://www.ibm.com/design/language/illustration/isometric-style/design"
      >
...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    href="https://www.carbondesignsystem.com/guidelines/motion/basics"
    >
