...
Iconography consists of visual symbols that represent ideas, objects or narratives. Icons can convey messages at a glance, enable interactivity and simplify complex concepts. IB M has three iconography types for various use cases: UI icons, app icons and pictograms.
