...
[IBM user interface icons](./ui-icons/design) represent ideas, objects or actions and appear throughout digital interfaces to guide users, enhance usability and save space. They’re commonly used in navigation menus, action buttons, forms, toolbars and media controls, helping users identify actions quickly. There may be instances when a small bold element is useful in other materials to represent the product.
...
[IBM pictograms](./pictograms/design) represent simplified, symbolic images used by IBMers in most use cases, from presentations and marketing materials when speaking about a feature or function of a specific product, to web pages, merchandise, posters and signage. They also work well as large elements in graphic moments or subtle backgrounds. 
