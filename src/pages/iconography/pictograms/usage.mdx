...
<DoDontRow>
<DoDont caption="Do treat pictograms as illustations with sufficient sizing.">
...
<DoDontRow>
<DoDont caption="Use the correct theme to ensure sufficient contrast.">

![Icon with correct color theme](images/expressivePictograms_usage-colorDo.svg)

</DoDont>
<DoDont type="dont" caption="Don’t use the incorrect theme.">
