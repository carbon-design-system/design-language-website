...
The color gradient provides color to the gradient strokes of the expressive pictogram. Use the same color gradient guidance as you would for a productive pictogram. This layer remains stationary on the icon grid at 45* and is masked by the gradient strokes for consistent color across each pictogram.
