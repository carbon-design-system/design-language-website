...
![Color gradient with icon grid](../app-icons/images/1_2-9_StrokeIcons_Elements_ColorGradient_Grid.svg)
...
![45° color gradient](../app-icons/images/1_2-10_StrokeIcons_Elements_ColorGradient_Angle.svg)
...
![Color gradients for dark backgrounds](../app-icons/images/1_2-11_StrokeIcons_Elements_ColorGradient_PaletteDark_v2.svg)

</Column>
<Column colMd={4} colLg={6}>

![Color gradients for light backgrounds](../app-icons/images/1_2-12_StrokeIcons_Elements_ColorGradient_PaletteLight_v2.svg)
