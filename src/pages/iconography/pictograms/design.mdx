...
Expressive strokes differ from productive strokes by stroke weight and use of gradient. In expressive pictograms, productive strokes remain at 0.72px while expressive strokes are doubled to 1.44px.
