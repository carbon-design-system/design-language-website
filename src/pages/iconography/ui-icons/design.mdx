---
title: UI icons
description: The style, strokes, perspective, corners and angles of IBM icons all echo our Plex(R) typeface. Use them to represent ideas, invite action or draw attention.
...
The grid contains 2px padding. This ensures icons will retain their desired scale and and surrounding white space when exported. Only extend artwork into the padding for additional visual weight or for specific details required to define the shape's content, meaning or character.
...
<DoDont type="dont" caption="Don’t place any part of the icon in the padding area.">
<ArtDirection>
...
Use a consistent corner radius of 2px for rounded shapes. The 2px radius can be increased by a multiple of two when necessary to make the icon’s metaphor understandable or object shape clearly defined.
