...
<DoDont colMd={6} colLg={6} type="dont" caption="Avoid random decimal points in the x and y coordinates.">
...
<DoDontRow>
<DoDont colMd={6} colLg={6} caption="Do place arrow points on the grid.">
...
<DoDontRow>
<DoDont colMd={6} colLg={6} caption="Do place at least one point of the angled stroke caps on the grid, if possible. ">
...
![](./assets/design/08-idl-iconography-ui-icons-design.png)
...
The grid contains 2px padding. This ensures icons will retain their desired scale and surrounding white space when exported. Extend artwork into the padding only for additional visual weight or for specific details required to define the shape’s content, meaning or character.
...
<DoDont type="dont" caption="Don’t create an icon with dimension.">
