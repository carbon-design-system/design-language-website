...
As IBM continues to develop new products and services, you may find the need to create a new UI icon. Follow the design and production guidelines found here. Secure required approvals from the Design Language team so that your new icon can be added into the icon library.
</PageDescription>
...
- All icons should be unique and not redundant with any existing icons in the system. Search the [library](https://www.carbondesignsystem.com/guidelines/iconography/library) for the keyword(s) associated with your proposed new icon to ensure that it is not already represented
- All icons should adhere to the [IBM Design Language visual style](/iconography/ui-icons/design)
