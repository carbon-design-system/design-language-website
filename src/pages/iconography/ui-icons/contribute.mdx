...
As IBM continues to develop new products and services, you may find the need to create a new UI icon. Follow the design and production guidelines found here. There are approvals required before a new icon can be introduced into the icon library.
