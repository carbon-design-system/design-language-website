...
When designing icons for touch surfaces, all targets should be 44px or greater. The icon can be smaller than 44 px if padding is added to the touch target with CSS to meet the 44 px minimum.
