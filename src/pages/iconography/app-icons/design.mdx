...
You can choose between any of the four color gradients below. Note that the
colors are adjusted for both light and dark backgrounds to appear best in either
context.
...
generally used when the icon needs to appear on a color background or in
situations when the icon shouldn’t call attention to itself with color, such as
disabled states. Fill icons use opacities of a single color to create gradients.
