...
Stroke app icons are largely based on the styling of UI Icons, following all of the same production guidelines other than color. When creating stroke app icon, reference the [UI icon guidance](/iconography/ui-icons/design) as a starting point.
