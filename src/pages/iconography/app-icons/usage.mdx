...
<DoDontRow>
<DoDont caption="Keep icons at scale and centered within the container.">
...
<DoDontRow>
<DoDont caption="Only use circle or square shapes for containers.">
...
<DoDont type="dont" caption="Don’t crop icons inside containers.">
...
<DoDont type="dont" caption="Don’t use app icons as a replacement for logos or as a sign-off in communications." colLg="6">
...
<DoDont type="dont" caption="Don’t use app icons as a replacement for logos or as a sign-off on merchandise." colLg="6">
...
<ImageGalleryImage alt="Product catalog example" title="Product catalog example" col={8}>

![Product catalog example](images/v2/34-idl-iconography-app-icons-usage.png)

</ImageGalleryImage>

<ImageGalleryImage alt="Product catalog example" title="Product catalog example" col={4}>

![Product catalog example](images/v2/34-idl-iconography-app-icons-usage1.png)
