...
You can choose a background color or gradient for native app icon container
shapes. Most icons are placed on a black or white background, but you may choose
alternative background colors within the color guidance of your app icon style.

Color app icons may be placed on background color values 10–20 and 90–100. Use
monochromatic app icons for color values 20–80, and make sure the icon complies
with
[IBM accessibility standards](https://www.carbondesignsystem.com/guidelines/accessibility/overview).
...
<DoDontRow>
<DoDont type="dont" caption="Don’t use monochromatic icons on backgrounds with inaccessible contrast.">

![Monochromatic app icon with inaccessible contrast to the background](images/2_2-10_NativeOS_Background_Dont1.svg)

</DoDont>
<DoDont type="dont" caption="Don’t use color app icons with mid-range color values. ">
