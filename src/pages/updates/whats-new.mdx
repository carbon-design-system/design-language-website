...
We are continously extending the IBM Plex® typeface family to be international and after over a year of development we’re proud to release IBM Plex Sans KR. It’s been a rigorous design process and the first of our ongoing Plex CJK (Chinese, Japanese, Korean) project. IBM Plex Sans KR comes in all eight weights and has been hinted for the best screen performance in digital environments. IBM Plex Sans KR is open source and now available to [download](https://github.com/IBM/plex/releases/latest) on GitHub or play with the any of the scripts with our typetester tool on the [Typeface](https://www.ibm.com/design/language/typography/typeface#type-tester) page.<br/>— <br/>12 March, 2020
