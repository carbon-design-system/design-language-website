...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    aspectRatio="2:1"
    href="https://ibm.ent.box.com/s/nqmwysqx38xmmkv0c2658qs8l2pjzvnx"
    actionIcon="launch"
    >

![illustrator Icon](../../../images/resource-cards/box.png)
...
![](./assets/example_api_connect.svg "IBM API Connect lifecycle API management solution hero image")

</Column>

<Column colMd={12} colLg={6}>

![](./assets/example_CP4D.svg "IBM Cloud Pak for Data hero image of data access tools")
...
<Column colMd={12} colLg={4}>

![](./assets/example_assistant.svg "steps in creating a customer service chatbot for bill payment")

</Column>

<Column colMd={12} colLg={8}>

![](./assets/example_guardium.svg "IBM Security Guardium data security, compliance and risk event dashboard views")
...
![](./assets/fidelity_desktop.svg "high, mid, and low fidelity examples of hybrid illustrations to demonstrate details and simplification")
...
![line-style and flat-style illustration options for hybrid UI illustrations](/assets/illustration.svg "line-style and flat-style illustration options for hybrid UI illustrations")
