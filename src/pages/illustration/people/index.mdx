...
![Skeleton structure example](./images/11_Skeleton-structure-v3.svg)
...
![People Portraiture example](./images/20_People_Portraiture-static2.png)
...
<div style="margin: 0;padding: 0;height: 8px" />
...
![Line style portrait example](./images/23_DougP_line-v2.png)

</Column>
<Column colMd={4} colLg={4}>

![Flat style portrait example](./images/24_DougP_Flat.png)

</Column>
<Column colMd={4} colLg={4}>

![Flat style high-fidelity portrait example](./images/25_DougP_Detailed.png)
...
![Bike flat style example](./images/34_Bike_FlatStyle_optimized1.gif)

![Bike flat style example](./images/34_Bike-Flatstyle_static-frame.png)
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      ...
      aspectRatio="2:1"
      href="https://www.ibm.com/design/language/files/IBM_People-Palette.zip"
      actionIcon="download"
      >
