---
title: Color
description: The IBM Color palette is blue at the core, expanding across color families and gradients, using specifications to represent mankind and machine in action.
---
