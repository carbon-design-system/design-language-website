...
Do not use colors for our logo that are not the IBM “core colors” and also please do not use unapproved color combos that have been noted in the [IBM color palette guidance](https://www.ibm.com/color).
