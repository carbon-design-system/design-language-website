...
<DoDontRow>
<DoDont type="dont" caption="Do not change stripes direction/weight">

![ dont change stripe direction example](images/usage-dont-stripe-direction.svg)

</DoDont>
<DoDont type="dont" caption="Do not make a dot matrix">
...
<DoDontRow>
<DoDont type="dont" caption="Do not extend serifs to touch">

![ don't extend serifs example](images/usage-dont-serifs-touch.svg)

</DoDont>
<DoDont type="dont" caption="Do not outline">
...
<DoDontRow>
<DoDont type="dont" caption="Do not outline and overlap">

![don't outline and overlap example](images/usage-dont-overlap.svg)

</DoDont>
<DoDont type="dont" caption="Do not place in container shape">
...
<DoDontRow>
<DoDont type="dont" caption="Do not add the “thought rays”">

![don't add thought rays example](images/usage-dont-thoughtrays.svg)

</DoDont>
<DoDont type="dont" caption="Do not add characters in same style">
...
<DoDont type="dont" caption="Do not use the solid logo for medium to large scale applications.">
...
<DoDont type="dont" caption="Do not use the solid logo in place of the 8-Bar for partnerships.">
...
<DoDont type="dont" caption="Do not use in place of the 8-Bar as a marketing sign off.">
...
<DoDont type="dont" caption="Do not apply to background colors other than White or Gray 10.">
