...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    href="https://ibm.my.workfront.com/requests/new?activeTab=tab-new-helpRequest&projectID=62b5b4ab00bd1899d2b6322f7ff09b9c&path=675712d60004897c9565fc8d16cb11fe"
  >
...
![logo alignments](images/IDL_IBM_logos_8-bar_alignment_quantum-v2.png)
...
![logo scale](images/IDL_IBM_logos_8-bar_scale_quantum.png)
...
liability and so on. IBM requires all third parties to comply with these
guidelines to ensure a consistent IBM brand identity across all messaging.
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      actionIcon="download"
      subTitle={"IBM logo guidelines for strategic partners"}
      href="https://www.ibm.com/design/language/files/IBM_logo_guidelines_strategic_partners_v_1_2.pdf"
      >
