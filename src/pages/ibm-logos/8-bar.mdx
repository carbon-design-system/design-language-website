...
<DoDontRow>
<DoDont type="dont" caption="Do not use colors that aren’t the core colors for the IBM logo." >

![example of colors not to use](images/logo_colordont_1.svg)

</DoDont>
<DoDont type="dont" caption="Do not break the five “steps” away rule.">

![example of colors not to use](images/logo_colordont_2.svg)

</DoDont>
<DoDont type="dont" caption="Do not use unapproved color combinations.">
...
<DoDontRow>
<DoDont type="dont" caption="Do not create stripes using different colors.">

![example of colors not to use](images/logo_colordont_4.svg)

</DoDont>
<DoDont type="dont" caption="Do not make each letter a different color.">

![example of colors not to use](images/logo_colordont_5.svg)

</DoDont>
<DoDont type="dont" caption="Do not use a gradient to color the logo.">
...
<DoDontRow>
<DoDont type="dont" caption="Do not change the direction or weight of the bars.">
...
<DoDont type="dont" caption="Do not extend the serifs to touch each other.">
...
<DoDontRow>
<DoDont type="dont" caption="Do not outline the bars.">

![don't outline the bars example](images/usage-dont-outline.svg)

</DoDont>
<DoDont type="dont" caption="Do not stretch or compress the logo.">

![don't stretch or compress the logo example](images/usage-dont-stretch.svg)

</DoDont>
<DoDont type="dont" caption="Do not alter the spacing between the letters.">
...
<DoDontRow>
<DoDont type="dont" caption="Do not outline or overlap the letters.">

![don't outline or overlap the letters example](images/usage-dont-overlap.svg)

</DoDont>
<DoDont type="dont" caption="Do not contain the logo in a shape.">

![don't contain the logo in a shape example](images/usage-dont-container.svg)

</DoDont>
<DoDont type="dont" caption="Do not add the smart rays.">
...
<DoDontRow>
<DoDont type="dont" caption="Do not add characters in the 8-bar design.">

![don't add characters in the 8-bar design example](images/usage-dont-add.svg)

</DoDont>
<DoDont type="dont" caption="Do not add your own taglines or mottos.">
