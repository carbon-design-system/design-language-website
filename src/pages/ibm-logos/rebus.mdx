...
The IBM core colors, consisting of the blue and gray families, are used when applying color specifically to the rebus. Please refer to the [color specifications](/color#specifications) for precise values. Here are a few examples of possible color combinations using core colors and positive and negative IBM rebuses.
