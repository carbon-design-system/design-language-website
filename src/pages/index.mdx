...
<Row>
  <Column colMd={4} colLg={4} noGutterMdLeft>
    <ArticleCard
      title="IBM Plex® Sans Chinese SC"
      date="December 2024"
      href="/whats-new#ibm-plex-sans-chinese-(simplified)"
      actionIcon="arrowRight"
      color="light"
    >

![IBM Plex Sans Chinese SC](../images/homepage/IBM_Plex_SC_Announcement.png)
...
![IBM Plex Math](../images/homepage/whatsnew_plexmath.svg)
  ...
  <Column colMd={4} colLg={4} noGutterMdLeft>
    <ArticleCard
      title="IBM Plex® Sans Chinese TC"
      date="September 2024"
      href="/whats-new#ibm-plex-sans-chinese-(traditional)"
      actionIcon="arrowRight"
      color="light"
    >

![IBM Plex Sans Chinese TC](../images/homepage/whatsnew_plexchinese.svg)
