...
<ResourceCard
  ...
  href="/files/Technical-diagrams-kit_v2.ai"
  actionIcon="download"
>
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Technical diagrams library (Figma)"
      aspectRatio="2:1"
...
<Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Technical diagrams guide (Figma)"
      aspectRatio="2:1"
...
Bullet nodes are useful for tree diagrams, dendrograms and other types of very dense network diagrams. Bullet nodes are the most compact form of a node. If using a horizontal label format, the node shape appears to the left of the primary label text. If using a vertical label format, the node shape appears centered above the primary label. Bullet nodes are usually not mixed with other types of nodes in the same diagram. They shouldn’t be used with long names or descriptions. 
...
![Examples of square elbow connection](./images/design/connectors/routing_elbow.svg)
...
![Examples of rounded elbow connection](./images/design/connectors/routing_rounded.svg)
...
![Examples of straight connection](./images/design/connectors/routing_straight.svg)
...
![Examples of bezier connection](./images/design/connectors/routing_bezier.svg)
...
![Use of Black or White UI icons, depending on the fill color](./images/design/iconography/icons_ui.svg)
...
![Use of app icons on monochromatic and colored fills](./images/design/iconography/icons_app.svg)
...
![Small node specifications](./images/design/grid-and-spacing/draw_2.svg)
...
![Large node with icons specifications](./images/design/grid-and-spacing/draw_3.svg)
...
![8px radius for rounded corners](./images/design/grid-and-spacing/draw_5.svg)
...
![Don’t mix colors when drawing a node. Nodes should be monochromatic. ](./images/design/color/color2.svg)
...
![Don’t rely on background fills to differentiate between categories of elements.](./images/design/color/color4.svg)
