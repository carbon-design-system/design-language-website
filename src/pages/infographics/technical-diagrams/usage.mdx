...
[IBM’s Unified Method Framework (UMF)](https://w3.ibm.com/w3publisher/ibm-architect-profession/education#Architectural_Thinking) is the modelling standard used by IBM for IT architecture. When creating an IT architecture diagram, follow the visual guidance developed specifically for this type of diagram. Doing so helps ensure correct interpretation of your architectural model.
