...
The technical diagrams guidance presented here is meant for diagrams that appear outside of product screens, such as those found in documentation websites, in presentations, on collateral and so on. When creating a technical diagram as part of a product, use the Carbon components and guidance instead. 
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="IT architecture visualization techniques"
  href="https://w3.ibm.com/w3publisher/it-architecture-visualisation-techniques"
  actionIcon="launch"
>
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="IT architecture starter kit"
