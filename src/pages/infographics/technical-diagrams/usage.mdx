...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="Cognitive Architect, internal (w3 ID required)"
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="Cognitive Architect, external"
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="Hybrid Cloud Architecture Center"
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
  subTitle="Diagrams.net library, desktop build, internal (w3 ID required)"
...
<ResourceCard
  download
  subTitle="IT architecture diagrams starter kit, PowerPoint (w3 ID required)"
  href="http://"
  actionIcon="launch"
>
